...
namespace Coordinates
{
    static class Converters
    {
        ...
        //=================================================
        public static void itm2wgs84(float N, float E, out double lat, out double lon)
        {
        ...
        //====================================
        public static void Grid2LatLon(float N, float E, out double lat, out double lon, int from, int to)
        {
            //================
            // GRID -> Lat/Lon
            //================
